<form method='GET'
    ...
    <button type="submit"
            class="block rounded-e-2xl bg-white/15 px-3 py-1.5 my-[1px] ml-1 uppercase text-white outline-2 outline-white/30 hover:outline-orange-600 hover:bg-orange-600/10 tracking-widest transition duration-300">найти</button>
